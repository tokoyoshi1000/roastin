    ...
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '60px 24px' }}>
      ...
      {status === 'done' && report && (
        <div>
          ...
          <div style={{
            background: CARD, border: '1px solid rgba(255,255,255,0.07)', borderRadius: 16,
            padding: '40px', lineHeight: 1.8, fontSize: 16,
    ...
    <div style={{ minHeight: '100vh', background: NAVY, color: '#fff', fontFamily: "'Inter', sans-serif" }}>
      ...
      <Suspense fallback={
        <div style={{ textAlign: 'center', padding: '80px 24px' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 18 }}>Loading…</p>
        </div>
      }>
        <SuccessContent />
      </Suspense>
